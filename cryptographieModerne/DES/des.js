...
var key = DES.generateRandomKey();
var message = DES.generateRandomMessage();

console.log("key: "+binaryToText(key.toString()));
console.log("mes: "+binaryToText(message.toString()));

let enc=DES.encrypt(key, message).final;

console.log("enc: "+binaryToText(enc.toString()));

console.log("dec: "+binaryToText(DES.decrypt(key, enc).final.toString()));
